      ...
      <div class="navbar">
        <div class="navbar-header">
          <a class="navbar-brand" href="/">
            <img src="https://tse3-mm.cn.bing.net/th/id/OIP-C.ZkoPhpKfJwsvGmpm8RsragHaFp?pid=ImgDet&rs=1">
            <h4>
              <!-- {{ settings.blogName }} -->
        ...
        <div class="navbar-collapse" :class="{ showMenu }">
          <ul>
            ...
            <li :class="{ 'blog-active': $route.path === '/guestbook' }" @click="hideMenu">
              <nuxt-link to="/guestbook">
                <font-awesome-icon :icon="['fas', 'comment-dots']" />留言
              </nuxt-link>
              <div class="nav-line"></div>
            </li>
            <li :class="{ 'blog-active': $route.path === '/profile' }" @click="hideMenu">
